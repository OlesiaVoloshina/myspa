...
PageImpl = __decorate([ injectable(), __param(0, inject(PageModelToken)), __param(1, inject(ComponentFactory)), __param(2, inject(ContentFactory)), __param(3, inject(LinkFactory)), __param(4, inject(LinkRewriterService)), __param(5, inject(MetaCollectionFactory)), __param(6, inject(EventBusService)), __param(6, optional()), __param(7, inject(EventBusService$1)), __param(7, optional()), __metadata("design:paramtypes", [ Object, ComponentFactory, ContentFactory, LinkFactory, Object, Function, Object, Object ]) ], PageImpl);
...
PageImpl$1 = PageImpl_1 = __decorate([ injectable(), __param(0, inject(PageModelToken)), __param(1, inject(ComponentFactory$1)), __param(2, inject(ContentFactory$1)), __param(3, inject(LinkFactory)), __param(4, inject(LinkRewriterService)), __param(5, inject(MetaCollectionFactory)), __param(6, inject(EventBusService)), __param(6, optional()), __param(7, inject(EventBusService$1)), __param(7, optional()), __metadata("design:paramtypes", [ Object, ComponentFactory$1, Function, LinkFactory, Object, Function, Object, Object ]) ], PageImpl$1);
